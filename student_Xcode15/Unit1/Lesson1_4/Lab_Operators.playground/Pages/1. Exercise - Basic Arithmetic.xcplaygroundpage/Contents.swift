...
print("when specified the double the value is decimal instead of the assumed interger")
/*:
...
print("The diameter equals to", diameter ,"And the circumference equals to", circumference )
...
print(even % 2)
print(odd % 2)
print("when the number divided by 2 leave a reminder equal to 1")
/*:
